              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={5}
                    className="w-full rounded-md border bg-background px-3 py-2 text-sm text-slate-900 outline-none transition focus:border-primary focus:ring-1 focus:ring-primary bg-card text-foreground"
            ...
            <CardHeader>
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm text-slate-500 text-muted-foreground">
                    Mostrar
                  </span>
                        ...
                        >
                          ...
                          <div className="flex items-start justify-between gap-3">
                            ...
                            <p className="text-sm font-semibold text-foreground">
                              ...
                              <p className="mt-1 text-xs uppercase tracking-[0.2em] text-slate-500 text-muted-foreground">
                                {notif.type}
                              </p>
                            </div>
