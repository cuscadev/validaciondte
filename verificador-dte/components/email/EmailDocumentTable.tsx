...
import type { EmailDocumentRow } from '@/lib/supabase-admin';
...
type Props = {
  ...
  onViewLinks: (doc: EmailDocumentRow) => void;
  onViewJson: (doc: EmailDocumentRow) => void;
};
...
export default function EmailDocumentTable({
  documents,
  selectedIds,
  onToggleSelect,
  onToggleAll,
